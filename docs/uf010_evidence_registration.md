...
>
> 状态建议: **⏸️待决策**(未授权·仅证据) —— 用户 2026-09-19 选择"登记进缺陷表, 不动产品码"。
...
## 9. 待办(给 writer-claude)

1. 在 `unfixed_defects.md` 第 1 节任务总表新增 UF-010 行(状态 `⏸️待决策`);
2. 在 §3 本体速览补一条一句话说明 + 指向本文件;
3. 若决策方要求把 §6 的推断坐实, 另开一轮 HEAD 插桩(一次即可), 本文件 §6 随之订正。
